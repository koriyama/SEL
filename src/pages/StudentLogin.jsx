...
const StudentLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // AuthContext will refresh the profile. If the student must change
      // their password, ProtectedRoute will redirect them automatically.
      navigate('/student');
    } catch (err) {
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center text-sm border-t border-gray-200 pt-4">
            <span className="text-gray-500">Are you a teacher? </span>
